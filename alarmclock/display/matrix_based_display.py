...
# Nerd Font to display numbers only
NERD_FONT = [
			[ 0x00, 0x00, 0x00 ],
			[ 0x00, 0x00, 0x00 ],
			[ 0x00, 0x00, 0x00 ],
...
ICONIC_FONT_BIG = [
			...
			[ 0x00, 0x00, 0x18, 0x18, 0x00, 0x00 ], # 1
			[ 0x00, 0x00, 0x66, 0x66, 0x00, 0x00 ], # 2
			[ 0x00, 0x00, 0x66, 0x66, 0x18, 0x18 ], # 3
			[ 0x18, 0x18, 0x7E, 0x7E, 0x18, 0x18 ], # 4
			[ 0x00, 0x00, 0x66, 0x66, 0x7E, 0x7E ], # 5
			[ 0x66, 0x66, 0x7E, 0x7E, 0x18, 0x18 ], # 6
			[ 0x78, 0x78, 0x7E, 0x7E, 0x78, 0x78 ], # 7
			[ 0x7E, 0x7E, 0x66, 0x66, 0x7E, 0x7E ], # 8
			[ 0x7E, 0x7E, 0x7E, 0x7E, 0x7E, 0x7E ], # 9
			[ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ], # :
]
...
ICONIC_FONT_SMALL = [
			...
			[ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ], # /
			[ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ], # 0
			[ 0x00, 0x00, 0x00, 0x10, 0x00, 0x00 ], # 1
			[ 0x00, 0x00, 0x00, 0x44, 0x00, 0x00 ], # 2
			[ 0x00, 0x00, 0x00, 0x44, 0x00, 0x10 ], # 3
			[ 0x00, 0x10, 0x00, 0x54, 0x00, 0x10 ], # 4
			[ 0x00, 0x00, 0x00, 0x44, 0x00, 0x54 ], # 5
			[ 0x00, 0x44, 0x00, 0x54, 0x00, 0x10 ], # 6
			[ 0x00, 0x50, 0x00, 0x54, 0x00, 0x50 ], # 7
			[ 0x00, 0x54, 0x00, 0x44, 0x00, 0x54 ], # 8
			[ 0x00, 0x54, 0x00, 0x54, 0x00, 0x54 ], # 9
			[ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 ], # :
]
...
class MatrixBasedDisplay(Display):
	...
	def _display_time(self):
		self._display_text(alignment=1) # default time displayed aligned right
