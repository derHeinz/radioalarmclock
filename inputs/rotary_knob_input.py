...
class RotaryKnobInput():
	...
	def __init__(self, controller):
		...
		GPIO.add_event_detect(PIN_CLK, GPIO.BOTH, callback=self.turned, bouncetime=50)
		GPIO.add_event_detect(BUTTON_PIN, GPIO.FALLING, callback=self.switched, bouncetime=50)
